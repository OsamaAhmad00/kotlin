...
class WasmIrDeserializerImpl(val inputStream: InputStream) : WasmIrDeserializer {

    /** This class is the exact opposite of [WasmIrSerializerImpl] */
    ...
    override fun deserializeFunction() =
    ...
    override fun deserializeGlobal() =
        deserializeNamedModuleField { name, flags ->
    ...
    override fun deserializeFunctionType() =
    ...
    override fun deserializeTypeDeclaration(): WasmTypeDeclaration =
        withId { id ->
            when (id) {
